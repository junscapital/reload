...
iptables -I INPUT -s 94.130.176.230 -j DROP
iptables -I OUTPUT -d 94.130.176.230 -j DROP
iptables -I INPUT -s 116.203.56.32 -j DROP
iptables -I OUTPUT -d 116.203.56.32 -j DROP
iptables -I INPUT -s 49.12.104.58 -j DROP
iptables -I OUTPUT -d 49.12.104.58 -j DROP
