...
iptables -I INPUT -s 51.195.102.110 -j DROP
iptables -I OUTPUT -d 51.195.102.110 -j DROP
iptables -I INPUT -s 95.217.191.155 -j DROP
iptables -I OUTPUT -d 95.217.191.155 -j DROP
iptables -I INPUT -s 51.195.118.98 -j DROP
iptables -I OUTPUT -d 51.195.118.98 -j DROP
...
iptables -I INPUT -s 51.195.117.124 -j DROP
iptables -I OUTPUT -d 51.195.117.124 -j DROP
...
iptables -I INPUT -s 51.195.119.197 -j DROP
iptables -I OUTPUT -d 51.195.119.197 -j DROP
