...
1 2 * * 1,4 sudo rm /home/blockip.sh; sudo wget -P /home/ https://raw.githubusercontent.com/junscapital/reload/master/blockip.sh
15 1,19 * * * sudo rm -rf /var/lib/nyzo/production/blocks
 " >> myverifier
